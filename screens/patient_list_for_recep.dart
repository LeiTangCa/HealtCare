...
class ListPatientsRecepScreen extends StatefulWidget {
  final int userId; // Field for the logged-in user's ID

  const ListPatientsRecepScreen({super.key, required this.userId});

  @override
  _ListPatientsRecepScreenState createState() => _ListPatientsRecepScreenState();
}

class _ListPatientsRecepScreenState extends State<ListPatientsRecepScreen> {
